...
export default function Builder() {
  ...
  return (
    <div style={{ display: 'flex', height: 'calc(100vh - 64px)', overflow: 'hidden', background: '#0d1117' }}>
      {/* ── Left Panel: Form ────────────────────────────────────────────── */}
      <div style={{ width: 420, flexShrink: 0, background: '#161b22', borderRight: '1px solid #30363d', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
        {/* Toolbar */}
      ...
      <div style={{ flex: 1, background: '#0a0e15', overflowY: 'auto', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '24px 16px' }}>
        <div style={{ fontSize: 12, color: '#9ca3af', marginBottom: 16, fontWeight: 500 }}>LIVE PREVIEW — A4 Format</div>
        <div id="cv-preview-inner" style={{ width: '210mm', background: 'white', minHeight: '297mm', boxShadow: '0 4px 24px rgba(0,0,0,0.12)', overflow: 'hidden' }}>
          <CVPreview scale={1} />
        </div>
